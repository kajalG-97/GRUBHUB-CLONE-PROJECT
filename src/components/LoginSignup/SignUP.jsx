   ...
   const registerHandler=()=>{
    ...
    >
      <Paper elevation={3}  sx={{padding:"30px" , display:"flex" ,flexDirection:"column" ,}}>
        ...
        <Button variant="contained" sx={{backgroundColor:"#572afb" ,color:"white "}} onClick={registerHandler}>
     Create your account
      </Button>
      ...
      <Typography sx={{display:"flex" , justifyContent:"center" , marginTop:"15px" ,marginBottom:"10px"}}>Have an account? <Link to={"/Login"}>Sign in</Link></Typography>
      </Paper>
    </Box>
